...
Future<Null> main(List<String> args) async {
  ...
  link = new LinkProvider(args, 'Mailer-', profiles: {
    ...
    AddGmailAccount.isType: (String path) => new AddGmailAccount(path, link),
    ...
    SendSMTPEmailNode.isType: (String path) => new SendSMTPEmailNode(path, link)
  }, defaultNodes: {
